...
if os.path.exists(os.path.join(ML_PATH, 'ml_pipeline.py')):
    ...
    # Also check parent directory (local dev)
    ML_PATH2 = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..'))
    if os.path.exists(os.path.join(ML_PATH2, 'ml_pipeline.py')):
        sys.path.insert(0, ML_PATH2)
        ML_AVAILABLE = True
    else:
        ML_AVAILABLE = False
